...
export function CountriesPage() {
  ...
  const fetchCountries = async () => {
    setIsLoading(true)
    try {
      // Mocking for now, adjust API handling as needed
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-zinc-900 dark:text-white">{country.name_ar || country.name || 'بدون إسم'}</p>
    ...
    <div className="space-y-8">
      ...
      <Card className="border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#0f0f11] shadow-sm overflow-hidden">
        ...
        <DataTable 
          ...
          emptyMessage="لا يوجد دول مضافة حتى الآن."
        />
      </Card>
    </div>
  )
